...
// console.log(Array.from(Object.values({ name: "Taher" }))); //Interesting because in case of objects we have to specify that it have to use keys or elements to make a Array.
